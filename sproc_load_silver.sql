...
=============================================================================================
Script Purpose:
  This stores procedure performs the ETL (Extract, Transforms, Load) Process to pupulate
...
BEGIN
	...
	BEGIN TRY
		...
		)t WHERE flag_last = 1; --Select the most recent record;
		...
		PRINT '>> Total Silver Table Load Duration: ' + CAST(DATEDIFF(second, @start_time, @end_time) AS NVARCHAR) + ' seconds';
